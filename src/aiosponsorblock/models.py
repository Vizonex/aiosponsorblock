...
class TotalStats(Struct):
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "TotalStats":
        self = cls.__new__(TotalStats)
...
class SearchedUser(Struct):
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> "SearchedUser":
        self = cls.__new__(SearchedUser)
